...
int main(void) {
    ...
    for (int row = 0; row < 20; row++) {
        for (int col = 0; col < 17; col++) {
            ...
            if (max < product) {
                printf("%d\t%d\t%d\t%d\n", arr[row][col], arr[row][col+1], arr[row][col+2], arr[row][col+3]);
                max = product;
            }
        }
    }
    ...
    for (int row = 0; row < 17; row++) {
        for (int col = 0; col < 20; col++) {
            ...
            if (max < product) {
                printf("%d\t%d\t%d\t%d\n", arr[row][col], arr[row+1][col], arr[row+2][col], arr[row+3][col]);
                max = product;
            }
        }
    }
    ...
    for (int row = 0; row < 17; row++) {
        for (int col = 0; col < 17; col++) {
            ...
            if (max < product) {
                printf("%d\t%d\t%d\t%d\n", arr[row][col], arr[row+1][col+1], arr[row+2][col+2], arr[row+3][col+3]);
                max = product;
            }
        }
    }
